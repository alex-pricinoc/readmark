defmodule Readmark.Accounts.User do
  use Readmark.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Readmark.Repo)
  ...
  """
  def valid_password?(%Readmark.Accounts.User{hashed_password: hashed_password}, password)

defmodule ReadmarkWeb.UserAuthTest do
  use ReadmarkWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Readmark.Accounts
  alias ReadmarkWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ReadmarkWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ReadmarkWeb.Endpoint.subscribe(live_socket_id)
